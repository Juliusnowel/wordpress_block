...
add_action('wp_enqueue_scripts', function(){
  ...
  $css = "
        ...
        /* Reset bullets + clean layout for WP paginate_links list output */
        .wmg-pager ul.page-numbers { 
        list-style: none; 
        margin: 0; 
        padding: 0; 
        display: flex; 
        ...
        /* Safety: no bullets on li either */
        .wmg-pager ul.page-numbers li { 
        list-style: none; 
        margin: 0; 
        padding: 0; 
        }

        /* Style each page item (anchors & spans) */
        .wmg-pager ul.page-numbers a.page-numbers,
        .wmg-pager ul.page-numbers span.page-numbers {
        display: inline-flex;
        align-items: center;
        ...
        /* Active page */
        .wmg-pager ul.page-numbers span.current {
        background: #564AFF;
        color: #fff;
        }

        .wmg-pager ul.page-numbers span.dots { 
        pointer-events: none; 
        }

        .wmg-pager ul.page-numbers {
        gap: 8px; /* tiny breathing room so the glow is visible */
        }
        ...
        .wmg-pager ul.page-numbers a.page-numbers::before,
        .wmg-pager ul.page-numbers span.page-numbers::before {
            content: '';
            position: absolute;
            inset: -10px;             
            border-radius: 14px;
            background: rgba(86,74,255,.12); 
            filter: blur(8px);
            opacity: 0;
            transform: scale(.95);
        ...
        .wmg-pager ul.page-numbers a.page-numbers:hover::before,
        .wmg-pager ul.page-numbers a.page-numbers:focus-visible::before {
        opacity: 1;
        transform: scale(1);
        }
        .wmg-pager ul.page-numbers a.page-numbers:hover,
        .wmg-pager ul.page-numbers a.page-numbers:focus-visible {
        ...
        .wmg-pager ul.page-numbers span.current::before {
        opacity: 1;                  
        transform: scale(1);
        display: none;
        }

        .wmg-pager ul.page-numbers a.prev:hover,
        .wmg-pager ul.page-numbers a.next:hover {
        transform: translateY(-1px);
        }
